...
#define STRING_CONFIG_H_AUTHOR "Steve Wagg aka CdRsKuLL https://pretendprusa.co.uk et Pascal Moignier" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sidewinder Genius PM
  #define DEFAULT_Kp 15.90
  #define DEFAULT_Ki 1.63
  #define DEFAULT_Kd 38.75 
...
// Penssez a redefinir  Pin Z_MIN_PIN et Z_MAX_PIN car le 3D_TOUCH est cablé sur le le D19 (Z_MAX_PIN au lieux de Z_MIN_PIN)
// dans le fichier Marlin\src\pins\ramps\pins_RAMPS.h #define Z_MIN_PIN 19 et  #define Z_MAX_PIN 18
// 
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 28, -33, -0.38 }
